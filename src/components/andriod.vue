<template>
    <div id="body">
        <div id="components_top">
            ...
            <p id="components_top_title">安卓介绍</p>
            <p id="signal">—— 一木一浮生，一草一天堂 ——</p>
            </div>
        </div>   
        <div id="introduce">
            ...
            <div id="about_word">
                <p id="direction_introduce">安卓简介</p>
                <p id="about_direction_word">ABOUT ANDRIOD</p>
        ...
        <div id="member_content">
            <p id="title">安卓成员</p>
            <p id="title_English">ANDRIOD MEMBER</p>
...
export default {
    ...
    mounted(){
        this.$store.commit('changeMenu','andriod');
    },
    created(){
        this.$axios.get('/proxy/person/listVisitor?group=3')
        .then(res=>{
        ...
        this.$axios.get('/proxy/group/get?id=3')
        .then(res=>{
