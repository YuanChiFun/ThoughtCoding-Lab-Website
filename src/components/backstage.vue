<template>
    <div id="body">
        <div id="components_top">
            ...
            <p id="components_top_title">后台介绍</p>
            <p id="signal">—— 一砂一极乐，一方一净土 ——</p>
            </div>
        </div>   
        <div id="introduce">
            ...
            <div id="about_word">
                <p id="direction_introduce">后台简介</p>
                <p id="about_direction_word">ABOUT SERVER</p>
        ...
        <div id="member_content">
            <p id="title">后台成员</p>
            <p id="title_English">BACKGROUND MEMBER</p>
...
export default {
    ...
    mounted(){
        this.$store.commit('changeMenu','backstage');
    },
    created(){
        this.$axios.get('/proxy/person/listVisitor?group=1')
        .then(res=>{
        ...
        this.$axios.get('/proxy/group/get?id=1')
        .then(res=>{
