<template>
    <div id="body">
        <div id="components_top">
            ...
            <p id="components_top_title">前端介绍
            </p>
            <p id="signal">—— 一颗沙里一个世界，一朵野花一座天堂 ——</p>
            </div>
        </div>   
        <div id="introduce">
            ...
            <div id="about_word">
                <p id="direction_introduce">前端简介</p>
                <p id="about_direction_word">WEB</p>
        ...
        <div id="member_content">
            <p id="title">前端成员</p>
            <p id="title_English">WEB MEMBER</p>
...
export default {
    ...
    created(){
        this.$axios.get('/proxy/person/listVisitor?group=4')
        .then(res=>{
        ...
        this.$axios.get('/proxy/group/get?id=4')
        .then(res=>{
    ...
    mounted(){
        this.$store.commit('changeMenu','web');
    },
}
</script>
<style scoped>
